...
typedef void (*_picohash_reset_fn)(void*);
typedef void (*_picohash_update_fn)(void*, const void*, size_t);
typedef void (*_picohash_final_fn)(void*, void*);
...
typedef struct {
    ...
    _picohash_reset_fn _reset;
    _picohash_update_fn _update;
    _picohash_final_fn _final;
    struct {
...
{
    const uint8_t *data = reinterpret_cast<const unsigned char*>(_data);
    for (; len != 0; --len) {
        ++s->byteCount;
...
inline void picohash_init_md5(picohash_ctx_t *ctx)
{
    ...
    ctx->_reset = reinterpret_cast<_picohash_reset_fn>(_picohash_md5_init);
    ctx->_update = reinterpret_cast<_picohash_update_fn>(_picohash_md5_update);
    ctx->_final = reinterpret_cast<_picohash_final_fn>(_picohash_md5_final);
...
inline void picohash_init_sha1(picohash_ctx_t *ctx)
{
    ...
    ctx->_reset = reinterpret_cast<_picohash_reset_fn>(_picohash_sha1_init);
    ctx->_update = reinterpret_cast<_picohash_update_fn>(_picohash_sha1_update);
    ctx->_final = reinterpret_cast<_picohash_final_fn>(_picohash_sha1_final);
...
inline void picohash_init_sha224(picohash_ctx_t *ctx)
{
    ...
    ctx->_reset = reinterpret_cast<_picohash_reset_fn>(_picohash_sha224_init);
    ctx->_update = reinterpret_cast<_picohash_update_fn>(_picohash_sha256_update);
    ctx->_final = reinterpret_cast<_picohash_final_fn>(_picohash_sha224_final);
...
inline void picohash_init_sha256(picohash_ctx_t *ctx)
{
    ...
    ctx->_reset = reinterpret_cast<_picohash_reset_fn>(_picohash_sha256_init);
    ctx->_update = reinterpret_cast<_picohash_update_fn>(_picohash_sha256_update);
    ctx->_final = reinterpret_cast<_picohash_final_fn>(_picohash_sha256_final);
...
inline void picohash_init_hmac(picohash_ctx_t *ctx, void (*initf)(picohash_ctx_t *), const void *key, size_t key_len)
{
    ...
    ctx->_reset = reinterpret_cast<_picohash_reset_fn>(_picohash_hmac_reset);
    ctx->_final = reinterpret_cast<_picohash_final_fn>(_picohash_hmac_final);
